      ...
      <section className="bg-white section-padding text-center">
        <div className="container-max">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-ink">
            Pre-Award <span className="text-gold">Activities</span>
          </h1>
              ...
              <div key={activity.id} className="gold-border-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ink/60 leading-relaxed">{activity.description}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {otherActivities.map((activity) => (
              <div key={activity.id} className="bg-surface-alt border border-gray-100 hover:border-gold/30 rounded-xl p-6 transition-all">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gold/10 flex items-center justify-center flex-shrink-0">
                    <RenderIcon name={activity.icon} size={24} className="text-gold" />
                  </div>
